      ...
      <div className="page-header">
        <div className="page-header-row">
          <div>
            ...
            <p>View full information for this user account.</p>
          </div>
        </div>
      </div>
            ...
            <div>
              ...
              <div className="status-badge-group">
                ...
                <StatusBadge
                  ...
                  label={account.isEmailVerified ? "Email verified" : "Email pending"}
                />
          ...
          <div className="detail-grid">
            <section className="card detail-section">
              ...
              <div className="detail-list">
                ...
                <DetailItem label="Password changed" value={formatDate(account.passwordChangedAt)} />
            ...
            {account.role === "admin" && (
              <section className="card detail-section">
                <h3>Administrator</h3>
                <p className="detail-note">This account has platform administrator privileges.</p>
              </section>
            )}
          </div>
        </>
